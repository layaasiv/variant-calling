...
## Conclusions
In the comparison of HaplotypeCaller and FreeBayes for variant calling in BWA-MEM aligned whole-genome sequencing data between Arabidopsis thaliana ecotypes Col-0 and Nd-1, both tools demonstrated comparable overall performance against the Schilbert et al. (2020) gold standard, with F1 scores of 0.481 and 0.464, respectively.
